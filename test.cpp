...
//        std::cout<<std::endl;
//    }
    Matrixf testsound_spec = power_stft * mel_basis.transpose();
//    std::cout << "mel_output:";
...
//    std::cout<<std::endl;
    ...
    std::vector<float> bigdata(audioFile.samples.at(0).begin(),audioFile.samples.at(0).end());
//    bigdata.insert(bigdata.end(),audioFile.samples.at(1).begin(),audioFile.samples.at(1).end());
    Vectorf data = Eigen::Map<Matrixf>(bigdata.data(),1,length).colwise().mean();
